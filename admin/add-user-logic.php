...
if (isset($_POST['submit'])) {
            ...
            if (mysqli_num_rows($user_check_result) > 0) {
                ...
                if (in_array($extension, $allowed_files)) {
                    ...
                    if ($avatar['size'] < 1000000) {
                        ...
                        $_SESSION['add-user'] = "Files are too big. Should be less than 1mb";
                    }
                } else {
                    $_SESSION['add-user'] = "File should be png, jpg, ot jpeg";
                }
            }
        }
    }
    ...
    if (isset($_SESSION['add-user'])) {
        ...
        if (!mysqli_errno($connection)) {
            ...
            $_SESSION['add-user-succcess'] = "New user $firstname $lastname added successfully.";
            header('location: ' . ROOT_URL . 'admin/manage-users.php');
            die();
        }
    } 
} else {
    //if button wasn't clicked, bonce back to signup page
    header('location: ' . ROOT_URL . 'admin/add-user.php');
    die();
}